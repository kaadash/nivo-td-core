...
var Axis = function Axis(_ref2) {
    ...
    var newValues = (0, _axes.computeAxisTicks)({
        width: width,
        height: height,
        scale: scale,
        position: _position,
    ...
    return _react2.default.createElement(
        ...
        legend,
        tickElements,
        _position === 'left' ? _react2.default.createElement('line', { x1: '0', x2: '0', y1: '0', y2: height, stroke: '#cacaca' }) : '',
        _react2.default.createElement('line', { stroke: 'red', x1: edgeTick.x, x2: width, y1: edgeTick.y, y2: edgeTick.y })
    );
};
...
var enhance = (0, _compose2.default)((0, _hocs.withMotion)(), (0, _withPropsOnChange2.default)(['format'], function (_ref5) {
